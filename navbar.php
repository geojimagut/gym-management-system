...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=schedule" class="nav-item nav-schedule"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> My schedule</a>
				...
				<a href="index.php?page=payment" class="nav-item nav-payment"><span class='icon-field'><i class="fa fa-money-bill"></i></span> My Payments</a>
